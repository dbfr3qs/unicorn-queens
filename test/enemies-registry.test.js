...
const ALL_KINDS = ['slime', 'zombie', 'ghost', 'mage', 'troll', 'bat', 'dragon', 'bee', 'snake', 'adder', 'spider', 'spiderboss', 'hare', 'wraith'];
...
describe('registry shape', () => {
  ...
  it('all 14 kinds are registered (catches a stub that never calls register)', () => {
